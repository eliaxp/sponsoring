...
SECRET_KEY = 'qv4pdi^$ptv_0-_o&at$^hi1+o$iso^r$zp698v*5^5*chf^gz'
...
# external apps install
EXTERNAL_APPS = (
    'django_countries',
    'social_django'
)
# local applications created
LOCAL_APPS = (
    'users',
    'core',
    'deliveries',
...
## force to request email
SOCIAL_AUTH_FACEBOOK_SCOPE = ['email']
# Google settings
SOCIAL_AUTH_GOOGLE_OAUTH2_KEY = ''
SOCIAL_AUTH_GOOGLE_OAUTH2_SECRET = ''

# setting custom user login
